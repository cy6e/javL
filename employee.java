...
String[] EmpName={"Abel","Oprah","Ghilsane","Wizz","Jake","Stewiw","Danny"};
//define join date
String[]
JoinDate={"01/04/2009","23/08/2012","12/11/2008","29/01/2013","16/07/2005","01/01/2000","12/06/20
06"};
...
int flag=0;
//Reads string input, parses(stores) it as int
//stores into id
int id=Integer.parseInt(args[0]);
//This loop traverses through EmpId array
//Checks if Id == EmpId
...
"+"Department"+""+"Designation DA");
System.out.print(EmpId[i]+"\t "+EmpName[i]+" \t
"+Department[i]);
//This Loop traverses through designation array and checks
//If they are equal
